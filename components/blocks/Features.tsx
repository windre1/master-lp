    ...
    <section className="py-20 md:py-32 max-w-5xl mx-auto px-6 space-y-12">
      ...
      <div className="grid gap-8">
        {(data.items || [
          ...
          return (
            <div key={i} className="bg-white p-8 md:p-16 rounded-[4.5rem] border border-blue-100/50 shadow-2xl shadow-blue-500/5 hover:shadow-blue-500/10 transition-all group overflow-hidden relative">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-10 md:gap-20">
                <div className="flex-1 space-y-6 text-center md:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-600 rounded-full">
                     ...
                     <span className="text-[10px] font-black tracking-[0.2em] uppercase italic">Fitur {i + 1}</span>
                  </div>
                  <h3 className="text-2xl md:text-5xl font-extrabold text-slate-900 tracking-[-0.02em] leading-tight italic">{f.t}</h3>
