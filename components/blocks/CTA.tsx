  ...
  return (
    <section id="cta-section" className="py-20 md:py-32 text-center max-w-5xl mx-auto px-6">
      <div className="bg-slate-900 rounded-[4rem] p-10 md:p-24 shadow-2xl shadow-slate-200 relative overflow-hidden group">
        ...
        <h2 className="text-3xl md:text-6xl font-extrabold mb-8 text-white tracking-[-0.03em] leading-[1.05] animate-in fade-in duration-1000">
        ...
        <a 
          ...
          className="inline-block px-14 py-6 text-white font-extrabold rounded-[2rem] shadow-xl hover:scale-105 transition-all uppercase tracking-[0.2em] text-[10px] md:text-xs"
        >
