...
export default function Editor() {
  ...
  const TEKOTOK_BLOCKS: Block[] = [
    ...
    { id: 't11', type: 'heading', data: { title: '⚠️ Ini Bukan Sekadar Tools', badge: 'center', textColor: '#ef4444', fontSize: '28' } },
    { id: 't12', type: 'text_only', data: { subtitle: 'Di dalamnya ada strategi penggunaan yang bisa memaksimalkan reach, bikin akun lebih konsisten, dan meningkatkan peluang viral.', badge: 'center' } },
    { id: 't13', type: 'heading', data: { title: 'Akses Tidak Selalu Dibuka', badge: 'center', fontSize: '24' } },
    { id: 't14', type: 'text_only', data: { subtitle: 'Tools ini hanya untuk yang serius mau scale. Jika Anda melihat halaman ini, Anda termasuk yang beruntung.', badge: 'center' } },
    { id: 't15', type: 'cta', data: { title: 'Siap Scale Konten Tanpa Batas?', subtitle: 'Stop capek upload manual. Saatnya pakai sistem automation sekarang.', ctaText: 'MULAI SEKARANG', buttonColor: '#2563eb' } }
  ];
